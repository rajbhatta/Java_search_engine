 ...
 *
 */
public class SearchPageRankWithContent 
{
	
	public ArrayList<PageRankObject> searchContentWithPageRank(String keyword,HttpServletResponse servletResponse,String url) throws Exception 
	{
		ArrayList<PageRankObject> ret = new ArrayList<PageRankObject>();
		String index = url + "/index/page-rank/";
		int total;
        ...
        while (mapIterator.hasNext()) 
        {
                ...
                ret.add(new PageRankObject(keyValue,value,total));
