...
import ir.uwindsor.cs.models.VLDBObject;
 ...
 *
 */
public class SearchVLDB 
{
	
	public ArrayList<VLDBObject> searchVLDB(String keyword,HttpServletResponse servletResponse,String url) throws Exception 
	{
		ArrayList<VLDBObject> ret = new ArrayList<VLDBObject>();
		String index = url + "/index/vldb/";
		int total;
		...
		total=results.totalHits;
		 ...
		 SimpleHTMLFormatter htmlFormatter = new SimpleHTMLFormatter("<span style=\"color:#CD3D6E\"><b>","</b></span>");
        ...
        while (mapIterator.hasNext()) 
        {
                ...
                ret.add(new VLDBObject(keyValue,value,total));
