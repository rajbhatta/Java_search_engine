...
<br/>
 <section id="contact">
        ...
        <table id="resultTable" class="table">
            ...
            <c:forEach items="${icseResult}" var="icseResultData" varStatus="i">
            	<tr class="active"><td> <a href="#" style="color:#2F6646"> 
				                  <span class="search-title"><span style="display:none;">${i.index+1}</span>&#9755; ${icseResultData.title} </span></a><br>
			<h6> Value:  ${icseResultData.pageRankValue}</h6></td>
            	</tr>
            </c:forEach>
