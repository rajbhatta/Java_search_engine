...
<br/>
 <section id="contact">
        ...
        <table id="resultTable" class="table">
          ...
          <c:forEach items="${vldbResult}" var="vldbResultData" varStatus="i">
            	<tr class="active"><td> <a href="#" style="color:#2F6646"> 
				                  <span class="search-title"><span style="display:none;">${i.index+1}</span>&#9755; ${vldbResultData.title} </span></a><br>
			<h6> Value:  ${vldbResultData.pageRankValue}</h6></td>
            	</tr>
            </c:forEach>
